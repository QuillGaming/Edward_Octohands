...
#define OVR_AUDIO_MINOR_VERSION 117
#define OVR_AUDIO_PATCH_VERSION 0

// Typedefs for backwards compatibility with OVR naming
typedef mxra_init_flags ovrAudioInitFlags;
typedef mxra_source_feature ovrAudioSourceFlag;
typedef mxra_attenuation_mode ovrAudioSourceAttenuationMode;
typedef mxra_context_feature ovrAudioEnable;
typedef mxra_acoustic_model ovrAudioAcousticModel;
typedef mxra_spatialization_status ovrAudioSpatializationStatus;
typedef mxra_ambisonic_format ovrAudioAmbisonicFormat;
typedef mxra_ambisonic_render_mode ovrAudioAmbisonicRenderMode;
typedef mxra_material_preset ovrAudioMaterialPreset;
typedef mxra_vector_3f ovrAudioVector3f;
typedef mxra_bands ovrAudioBands;
...
#endif
typedef mxra_ambisonic_stream ovrAudioAmbisonicStream;
typedef mxra_spectrum_analyzer ovrAudioSpectrumAnalyzer;
typedef mxra_allocate_callback ovrAudioAllocateCallback;
typedef mxra_deallocate_callback ovrAudioDeallocateCallback;
typedef mxra_context_config ovrAudioContextConfiguration;
typedef MXRA_RAYCAST_CALLBACK OVRA_RAYCAST_CALLBACK;
...
typedef struct _ovrAudioAdvancedBoxRoomParameters {
  ...
  mxra_bands abrp_ReflectLeft, abrp_ReflectRight; ///< Reflection bands (0 - 1.0)
  mxra_bands abrp_ReflectUp, abrp_ReflectDown; ///< Reflection bands (0 - 1.0)
  mxra_bands abrp_ReflectBehind, abrp_ReflectFront; ///< Reflection bands (0 - 1.0)
  ...
  mxra_vector_3f abrp_RoomPosition;
} ovrAudioAdvancedBoxRoomParameters;

// Constants for backward compatibility
#define ovrAudioEnable_COUNT MXRA_CONTEXT_FEATURE_COUNT
#define ovrAudioAcousticModel_COUNT MXRA_ACOUSTIC_MODEL_COUNT
#define ovrAudioMaterialPreset_COUNT MXRA_MATERIAL_PRESET_COUNT

// Individual enum constants for backward compatibility
#define ovrAudioInitFlag_Default MXRA_INIT_FLAG_DEFAULT
#define ovrAudioInitFlag_ThreadUnsafe MXRA_INIT_FLAG_THREAD_UNSAFE
#define ovrAudioInitFlag_LazyAllocations MXRA_INIT_FLAG_LAZY_ALLOCATIONS

#define ovrAudioSourceFlag_None MXRA_SOURCE_ENABLE_NONE
#define ovrAudioSourceFlag_ReflectionsDisabled MXRA_SOURCE_DISABLE_ACOUSTICS
#define ovrAudioSourceFlag_MediumAbsorption MXRA_SOURCE_ENABLE_MEDIUM_ABSORPTION
#define ovrAudioSourceFlag_Directivity MXRA_SOURCE_ENABLE_DIRECTIVITY
#define ovrAudioSourceFlag_AmbiDirect MXRA_SOURCE_ENABLE_AMBI_DIRECT
#define ovrAudioSourceFlag_DirectSoundDisabled MXRA_SOURCE_DISABLE_DIRECT_SOUND

#define ovrAudioSourceAttenuationMode_None MXRA_ATTENUATION_MODE_NONE
#define ovrAudioSourceAttenuationMode_Fixed MXRA_ATTENUATION_MODE_FIXED
#define ovrAudioSourceAttenuationMode_InverseSquare MXRA_ATTENUATION_MODE_INVERSE_SQUARE
#define ovrAudioSourceAttenuationMode_COUNT MXRA_ATTENUATION_MODE_COUNT

#define ovrAudioEnable_None MXRA_CONTEXT_FEATURE_NONE
#define ovrAudioEnable_EarlyReflections MXRA_CONTEXT_FEATURE_EARLY_REFLECTIONS
#define ovrAudioEnable_LateReverberation MXRA_CONTEXT_FEATURE_LATE_REVERBERATION
#define ovrAudioEnable_RandomizeReverb MXRA_CONTEXT_FEATURE_RANDOMIZE_REVERB
#define ovrAudioEnable_PerformanceCounters MXRA_CONTEXT_FEATURE_PERFORMANCE_COUNTERS
#define ovrAudioEnable_Diffraction MXRA_CONTEXT_FEATURE_DIFFRACTION

#define ovrAudioAcousticModel_Automatic MXRA_ACOUSTIC_MODEL_AUTOMATIC
#define ovrAudioAcousticModel_None MXRA_ACOUSTIC_MODEL_NONE
#define ovrAudioAcousticModel_Shoebox MXRA_ACOUSTIC_MODEL_SHOEBOX
#define ovrAudioAcousticModel_AcousticRayTracing MXRA_ACOUSTIC_MODEL_ACOUSTIC_RAY_TRACING

#define ovrAudioSpatializationStatus_None MXRA_SPATIALIZATION_STATUS_NONE
#define ovrAudioSpatializationStatus_Finished MXRA_SPATIALIZATION_STATUS_FINISHED
#define ovrAudioSpatializationStatus_Working MXRA_SPATIALIZATION_STATUS_WORKING

#define ovrAudioAmbisonicFormat_FuMa MXRA_AMBISONIC_FORMAT_FUMA
#define ovrAudioAmbisonicFormat_AmbiX MXRA_AMBISONIC_FORMAT_AMBIX

#define ovrAudioAmbisonicRenderMode_SphericalHarmonics MXRA_AMBISONIC_RENDER_MODE_SPHERICAL_HARMONICS
#define ovrAudioAmbisonicRenderMode_Mono MXRA_AMBISONIC_RENDER_MODE_MONO
...
#define ovrError_AudioSharedReverbDisabled MXRA_ERROR_SHARED_REVERB_DISABLED
...
#define ovrAudioMaterialPreset_AcousticTile MXRA_MATERIAL_PRESET_ACOUSTIC_TILE
#define ovrAudioMaterialPreset_Brick MXRA_MATERIAL_PRESET_BRICK
#define ovrAudioMaterialPreset_BrickPainted MXRA_MATERIAL_PRESET_BRICK_PAINTED
#define ovrAudioMaterialPreset_Cardboard MXRA_MATERIAL_PRESET_CARDBOARD
#define ovrAudioMaterialPreset_Carpet MXRA_MATERIAL_PRESET_CARPET
#define ovrAudioMaterialPreset_CarpetHeavy MXRA_MATERIAL_PRESET_CARPET_HEAVY
#define ovrAudioMaterialPreset_CarpetHeavyPadded MXRA_MATERIAL_PRESET_CARPET_HEAVY_PADDED
#define ovrAudioMaterialPreset_CeramicTile MXRA_MATERIAL_PRESET_CERAMIC_TILE
#define ovrAudioMaterialPreset_Concrete MXRA_MATERIAL_PRESET_CONCRETE
#define ovrAudioMaterialPreset_ConcreteRough MXRA_MATERIAL_PRESET_CONCRETE_ROUGH
#define ovrAudioMaterialPreset_ConcreteBlock MXRA_MATERIAL_PRESET_CONCRETE_BLOCK
#define ovrAudioMaterialPreset_ConcreteBlockPainted MXRA_MATERIAL_PRESET_CONCRETE_BLOCK_PAINTED
#define ovrAudioMaterialPreset_Curtain MXRA_MATERIAL_PRESET_CURTAIN
#define ovrAudioMaterialPreset_Foliage MXRA_MATERIAL_PRESET_FOLIAGE
#define ovrAudioMaterialPreset_Glass MXRA_MATERIAL_PRESET_GLASS
#define ovrAudioMaterialPreset_GlassHeavy MXRA_MATERIAL_PRESET_GLASS_HEAVY
#define ovrAudioMaterialPreset_Grass MXRA_MATERIAL_PRESET_GRASS
#define ovrAudioMaterialPreset_Gravel MXRA_MATERIAL_PRESET_GRAVEL
#define ovrAudioMaterialPreset_GypsumBoard MXRA_MATERIAL_PRESET_GYPSUM_BOARD
#define ovrAudioMaterialPreset_Marble MXRA_MATERIAL_PRESET_MARBLE
#define ovrAudioMaterialPreset_Mud MXRA_MATERIAL_PRESET_MUD
#define ovrAudioMaterialPreset_PlasterOnBrick MXRA_MATERIAL_PRESET_PLASTER_ON_BRICK
#define ovrAudioMaterialPreset_PlasterOnConcreteBlock MXRA_MATERIAL_PRESET_PLASTER_ON_CONCRETE_BLOCK
#define ovrAudioMaterialPreset_Rubber MXRA_MATERIAL_PRESET_RUBBER
#define ovrAudioMaterialPreset_Soil MXRA_MATERIAL_PRESET_SOIL
#define ovrAudioMaterialPreset_SoundProof MXRA_MATERIAL_PRESET_SOUND_PROOF
#define ovrAudioMaterialPreset_Snow MXRA_MATERIAL_PRESET_SNOW
#define ovrAudioMaterialPreset_Steel MXRA_MATERIAL_PRESET_STEEL
#define ovrAudioMaterialPreset_Stone MXRA_MATERIAL_PRESET_STONE
#define ovrAudioMaterialPreset_Vent MXRA_MATERIAL_PRESET_VENT
#define ovrAudioMaterialPreset_Water MXRA_MATERIAL_PRESET_WATER
#define ovrAudioMaterialPreset_WoodThin MXRA_MATERIAL_PRESET_WOOD_THIN
#define ovrAudioMaterialPreset_WoodThick MXRA_MATERIAL_PRESET_WOOD_THICK
#define ovrAudioMaterialPreset_WoodFloor MXRA_MATERIAL_PRESET_WOOD_FLOOR
#define ovrAudioMaterialPreset_WoodOnConcrete MXRA_MATERIAL_PRESET_WOOD_ON_CONCRETE
#define ovrAudioMaterialPreset_MetaDefault MXRA_MATERIAL_PRESET_META_DEFAULT
...
inline ovrResult ovrAudio_GetReflectionBands(ovrAudioMaterialPreset Preset, ovrAudioBands Bands) {
  return mxra_get_reflection_bands(Preset, Bands);
}
